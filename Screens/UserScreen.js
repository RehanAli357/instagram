      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <View style={styles.headerIcons}>
            <TouchableOpacity
              onPress={() => {
                setIsOpen({ type: "more", visibility: true });
              }}
            >
              <Image
            ...
            <TouchableOpacity
              onPress={() => {
                setIsOpen({ type: "handbuger", visibility: true });
              }}
            >
              <Image
        ...
        <View style={styles.profileSection}>
          <TouchableOpacity
            onLongPress={() => {
              setIsOpen({ visibility: true, type: "profile" });
            }}
          >
            <Image
        ...
        <View style={styles.stories}>
          ...
          <View style={styles.story}>
            <Image
              ...
              style={styles.storyImage}
            />
            <Text style={styles.storyText}>Story 2</Text>
          </View>
          <View style={styles.story}>
            <Image
              source={require("../assets/friends.jpg")}
              style={styles.storyImage}
            />
            <Text style={styles.storyText}>Story 3</Text>
          </View>
          <View style={styles.story}>
            <View
              style={[
